...
<body class="container mt-5"> 
  ...
  <a href="koneksi/add.php" class="btn btn-primary mb-3">+ Tambah 
Mahasiswa</a> 
    ...
    <tbody> 
      ...
      while ($row = mysqli_fetch_assoc($result)) { 
        echo "<tr> 
                ...
                <td>{$row['nim']}</td> 
                <td> 
                  <a href='koneksi/edit.php?id={$row['id']}' class='btn btn
warning btn-sm'>Edit</a> 
                  <a href='koneksi/delete.php?id={$row['id']}' class='btn btn
